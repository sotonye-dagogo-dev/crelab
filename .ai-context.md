...
| Services | `services/` | OOP class-based: BookingService, EscrowService, PortfolioService, DriveService, PaymentService, ReviewService |
...
Greenfield project — `.ai-system` governance structure is initialized. Next: begin Milestone 1.0 (Foundation) from ROADMAP — repo setup, config shell, global types, DB schema, auth, and component wrapper layer.
