...
Active development — Milestones 1.0-1.4 substantially complete. See `.ai-system/summaries/dev-history.md` for sprint log. Remaining MVP items: onboarding wizard UI, tests. Phase 2: dashboards, messaging, notifications.
