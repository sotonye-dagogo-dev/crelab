...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      {/* View Mode Toggle — available regardless of authentication (guest + auth) */}
      <div className="max-w-[1200px] mx-auto px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="text-[12px] text-[var(--color-text-tertiary)]">
          {viewMode === "creators" ? "Provider view — display photo preferred, else portfolio rotation, else name" : "Content view — tap any asset to play/view, provider link stays on the tile"}
        </div>
      </div>
